...
test("test getProductImage", async () => {
    ...
    expect(getProductImage(1, 55)).toBe("https://www.sephora.com/productimages/sku/s2031441-main-zoom.jpg?imwidth=270");
    expect(getProductImage(1, 3)).toBe("https://placeholderimagegenerator.com/wp-content/uploads/2024/12/Light-placeholder-image-portrait_jpg_.jpg");
    expect(getProductImage(1, 1)).toBe("https://www.sephora.com/productimages/sku/s1863588-main-zoom.jpg?imwidth=270&pb=clean-at-sephora");
    expect(getProductImage(1, 55)).toBe("https://www.sephora.com/productimages/sku/s2031441-main-zoom.jpg?imwidth=270");
});
...
test("test DB call", async () => {
    ...
    expect(fetchImageFromDB(3)).toBe("https://placeholderimagegenerator.com/wp-content/uploads/2024/12/Light-placeholder-image-portrait_jpg_.jpg");
});


test("test time to live", async () => {
    //changed TTL to 1 second and verified that it is refetched from API
    expect(fetchImageFromDB(3)).toBe("https://www.sephora.com/productimages/sku/s2031391-main-zoom.jpg?imwidth=270");
});
