const { computeProductScore } =
    require("../helpers/scoring-helper-functions.js").default;
...
const user2 = {
    ...
    loved_products: [
        ...
        },
        {
            ...
            product_type: "serum",
            price: "7",
            concerns: ["acne & blemishes", "texture"],
            skin_type: ["oily", "combination"],
            ingredients: [
                {
                    id: 257,
                    ...
                    purpose:
                        "deep exfoliant, helps with acne treatment and clogged pores",
                    skin_type: ["oily"],
        ...
        },
        {
            ...
            ingredients: [
                ...
                },
                {
                    ...
                    purpose:
                        "controls oil production, anti-inflammatory, regulates sebum",
                    skin_type: ["oily"],
...
const user3 = {
    // tons of liked and disliked products to test parsing liked/disliked
    username: "victoria",
    concerns: ["texture"],
    skin_type: ["dry", "normal"],
    loved_products: [
...
const user4 = {
    username: "victoria2",
    concerns: ["redness & irritation", "acne & blemishes"],
    skin_type: ["oily", "combination"],
    loved_products: [],
    saved_products: [],
    disliked_products: [
...
test("test compute score", () => {
    ...
    const score1 = computeProductScore(
        productToCheck,
        lovedProducts,
        dislikedProducts,
        userSkinType,
    ...
    const score2 = computeProductScore(
        productToCheck2,
        lovedProducts2,
        dislikedProducts2,
        userSkinType2,
